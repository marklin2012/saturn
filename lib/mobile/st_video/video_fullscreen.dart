...
import 'package:saturn/mobile/st_video/video_basic.dart';
import 'package:saturn/mobile/st_video/video_control.dart';
import 'package:saturn/mobile/st_video/video_progress.dart';
import 'package:saturn/mobile/st_video/video_sound.dart';
...
class _STVideoFullScreenState extends State<STVideoFullScreen> {
  ...
  Widget _getDefaultSoundIcon() {
    return STButton.icon(
      icon: getVolumeIcon(_soundValue, Axis.vertical, Colors.white, 16.0),
